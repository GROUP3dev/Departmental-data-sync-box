...
public class CreateAccount extends JFrame {
    ...
    private JPanel createWelcomePanel() {
        ...
        // Sub-text Label
        JLabel subTextLabel = new JLabel("<html><div style='text-align: center;'>To keep connected with us please<br>login with your personal info</div></html>", SwingConstants.CENTER);
        ...
        // "SIGN IN" Button
        JButton signInButton = new OutlinedButton("SIGN IN");
        gbc.gridy = 2;
        gbc.insets = new Insets(20, 100, 10, 100);
        welcomePanel.add(signInButton, gbc);
    ...
    private JPanel createSignUpPanel() {
        ...
        signUpPanel.setBackground(COLOR_BACKGROUND_WHITE);
        ...
        createAccountLabel.setFont(FONT_MAIN);
        createAccountLabel.setForeground(COLOR_PRIMARY_GREEN);
        gbc.gridy = 0;
        gbc.gridwidth = 2;
        gbc.insets = new Insets(10, 20, 30, 20);
        signUpPanel.add(createAccountLabel, gbc);
        ...
        // Name Field
        gbc.gridy = 1;
        signUpPanel.add(createIconTextField("👤", "Name"), gbc);

        // Email Field
        gbc.gridy = 2;
        signUpPanel.add(createIconTextField("✉️", "Email"), gbc);

        // Password Field
        gbc.gridy = 3;
        signUpPanel.add(createIconPasswordField("🔒", "Password"), gbc);

        // "SIGN UP" Button
        JButton signUpButton = new SolidButton("SIGN UP");
        gbc.gridy = 4;
